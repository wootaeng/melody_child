...
import { HOP_MS } from './slicer.js';

// 프레임 간격. 슬라이서와 **같은 상수**를 쓴다 — 두 모듈이 같은 프레임을 봐야
// "음절로 잡힌 것/못 잡힌 것"을 같은 기준으로 말할 수 있고, slicer.coverQuietEdges는
// bounds가 이 격자에 양자화돼 있다고 보고 프레임 인덱스를 되돌린다.
export const RIDE_HOP_MS = HOP_MS;
